...
SG.Name="Duy_Gate"; SG.ResetOnSpawn=false
...
Ttl.BackgroundTransparency=1; Ttl.Text="lấy 1 lần = vĩnh viễn"
...
SPT.BackgroundTransparency=1; SPT.Text="Ho tro"
...
SPS.BackgroundTransparency=1; SPS.Text=""
...
Ft.BackgroundTransparency=1; Ft.Text="1 lần = vĩnh viễn  v1"
        ...
        task.delay(0.32,function()
            ...
            task.spawn(function()
                ...
                local function makeText(timeStr)
                    return "Thoi gian con lai: "..timeStr.." |  1 lần = vĩnh viễn"
                end
