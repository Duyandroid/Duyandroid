if (game:GetService("CoreGui")):FindFirstChild("Androidhud") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).Androidhud:Destroy();
...
ImageButton.Image = "rbxassetid://136271563535852";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("Androidhud")).Enabled = not (game.CoreGui:FindFirstChild("Androidhud")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Androidhud") then
			makefolder("Androidhud");
		end;
		if not isfolder("Androidhud/Library/") then
			makefolder("Androidhud/Library/");
		end;
		if not isfile(("Androidhud/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Androidhud/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Androidhud/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("Androidhud/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Androidhud/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local Androidhud = Instance.new("ScreenGui");
	Androidhud.Name = "Androidhud";
	Androidhud.Parent = game.CoreGui;
	Androidhud.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = Androidhud;
	...
	CreateButton("Reset Config", function()
		if isfolder("Androidhud") then
			delfolder("Androidhud");
		end;
	...
	function uitab:Tab(text, img)
		...
		function main:Seperator(text)
			...
			Sep1.RichText = true;
			Sep1.Text = "Androidhud<font color=\"rgb(255, 0, 0)\">Androidhud</font>";
			...
			Sep3.RichText = true;
			Sep3.Text = "<font color=\"rgb(255, 0, 0)\">Androidhud</font>Androidhud";
