...
game:GetService("CoreGui").RobloxPromptGui.promptOverlay.ChildAdded:Connect(function(child)
    if not hopserver and child.Name == 'ErrorPrompt' and child:FindFirstChild('MessageArea') and child.MessageArea:FindFirstChild("ErrorFrame") then
        print("Duy Trường Auto Bounty | Đang vào lại!")
...
function wEarn(targ, earn, total) 
    if getgenv().Setting.Webhook.Enabled and getgenv().killed then
        ...
        local data = {
            ...
            ["embeds"] = {
                {
                    ["title"] = "**Duy Trường Hub | Auto Bounty**",
                    ...
                    ["thumbnail"] = {
                        ["url"] = "https://vi.xhname.com/videos/nezuko-loves-getting-her-pussy-fucked-without-mercy-xhUpLe3?_gl=1%2Aoi19r5%2A_ga%2AT2dZYlZYTzdRSXFudWEtT2JRX05oMGx1RDY1dzJRTHo2V2FlOUU1WTFQMjZDaXQtdWRDb1FmN19FbnMzN01ucg..%2A_ga_M59JX8S6QE%2AMTc3MjMzNzYwMS40LjEuMTc3MjMzNzYwMS4wLjAuMA..",
                    },
                    ["footer"] = {
                        ["text"] = "Auto bounty - Duy Trường",
                    },
...
-- === QUẢN LÝ CÀI ĐẶT ===
local foldername = "Duy Trường Hub Auto Bounty"
