...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://130379077525916",
...
--     end
-- end);
local v12 = loadstring(game:HttpGet("https://raw.githubusercontent.com/AnhDzaiScript/Setting/refs/heads/main/FastMax.lua"))();
