...
local v484 = v466:MakeTab({"Th\195\180ng Tin | Info","rbxassetid://100173004454294"})
local v485 = v466:MakeTab({"Farming","rbxassetid://100173004454294"})
local v486 = v466:MakeTab({"Auto Fishing","rbxassetid://100173004454294"})
local v487 = v466:MakeTab({"Quest | Items","rbxassetid://100173004454294"})
local v488 = v466:MakeTab({"Volcano Dojo","rbxassetid://100173004454294"})
local v489 = v466:MakeTab({"Sea Event","rbxassetid://100173004454294"})
local v490 = v466:MakeTab({"Race V4","rbxassetid://100173004454294"})
local v491 = v466:MakeTab({"Raid Fruits","rbxassetid://100173004454294"})
local v492 = v466:MakeTab({"Fruits | Check Stock","rbxassetid://100173004454294"})
local v493 = v466:MakeTab({"Teleport","rbxassetid://100173004454294"})
local v494 = v466:MakeTab({"PvP,Player","rbxassetid://100173004454294"})
local v495 = v466:MakeTab({"Shop","rbxassetid://100173004454294"})
local v496 = v466:MakeTab({"Settings","rbxassetid://100173004454294"})
v484:AddDiscordInvite({
    Name = "Tham Gia Discord",
    Description = "Link Sever Discord",
    Logo = "rbxassetid://77576958738832",
...
v484:AddDiscordInvite({
    ...
    Logo = "rbxassetid://77576958738832",
    Invite = " https://www.tiktok.com/@real_nanatvroblox?_r=1&_t=ZS-92cvg2WM18G"
})
