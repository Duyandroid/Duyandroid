...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Duyandroid/Duyandroid/refs/heads/main/FPS%20B%E1%BA%A3y%20M%C3%A0u.lua"))();
...
local function NotificacaoNightMystic(titulo, mensagem)
    local success = pcall(function()
        ...
        local LogoID = "rbxassetid://136271563535852"
        local duration = 5
...
local MinimizeButton = Window:AddMinimizeButton({
    Button = { 
        Image = "rbxassetid://136271563535852", -- Dùng ID ảnh bạn chọn
...
Discord:AddDiscordInvite({
    Name = "Duy Trường Script | Community✅",
    Description = "discord",
