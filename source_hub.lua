...
ImageButton1.Image = "rbxassetid://136271563535852"
...
function Update:Window(text,logo,keybind)
    ...
    Ping.Text = "Blox Kid          [RightControl]"
    ...
    UserImage.Image = "rbxassetid://136271563535852"
    ...
    function uitab:AddTab(text,img)
        ...
        IDK.Image = "rbxassetid://136271563535852" .. tostring(img)
    ...
    function main:AddButton(text, callback)
        if logo == nil then
            logo = "rbxassetid://136271563535852"
        end
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://136271563535852"
    ...
    function main:AddDropdown(text,option,callback)
        ...
        DropImage.Image = "rbxassetid://136271563535852"
...
local Library = Update:Window("Duy Trường Hub","",Enum.KeyCode.RightControl);
...
local Ss = Library:AddTab("Stats","7040410130")
  ...
  H:AddLine()
H:AddLabel("Duy Trường Hub [ Script Free ]")

H:AddSeperator("Credits")

H:AddLabel("Script Made By T...#9692")

H:AddLabel("Join My Discord Duy Trường Hub!")
                ...
                if _G.AutoObservation then
                    if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                        game:GetService("StarterGui"):SetCore("SendNotification", {
                            Icon = "rbxassetid://136271563535852";
                            Title = "Observation", 
