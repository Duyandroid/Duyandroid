...
-- Giới hạn FPS để máy không quá tải (60fps là đủ)
local targetFPS = 60
local lastTime = tick()
...
-- ==========================================
Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/robloxtbv-cloud/helloanhemeemme/refs/heads/main/3636363636363636.lua"))()

Window = Library:CreateWindow({
    Title = "Duy Trường Hub",
    Desc = "Blox Kid",
    Image = "rbxassetid://136944287595348"
})
...
Tabs.Info:AddButton({
    ["Title"] = " Duy Trường Script | Community",
    ["Description"] = "Discord",
    ["Callback"] = function()
        setclipboard(tostring("chưa có"))
    end
})
Tabs.Info:AddButton({
    ["Title"] = "Youtube",
...
Tabs.Info:AddButton({
    ...
    ["Description"] = "Tiktok",
    ["Callback"] = function()
        setclipboard(tostring("Duy Trường"))
    end
})
